...
const TRANSLATIONS = {
  fr: {
    ...
    "card.mode.edit":      "✏ Éditer",
    "card.mode.view":      "👁 Voir",
    "card.view.hint":      "Cliquez sur une LED pour voir l'entité associée",
    "card.live":           "⬤ Live",
    ...
    "tpl.on_off":            "On/Off",
    "tpl.unavailable_alert": "Alerte indisponible",
    "tpl.temp_hot":          "Température chaude (équipement)",
    "tpl.temp_fridge":       "Réfrigérateur (°C)",
    "tpl.temp_freezer":      "Congélateur (°C)",
    "tpl.temp_room":         "Pièce / confort (°C)",
    "tpl.humidity_plant":    "Humidité sol / plante (%)",
    "tpl.humidity_room":     "Humidité maison (%)",
    "tpl.power_instant":     "Puissance (W)",
    "tpl.energy_period":     "Énergie (kWh)",
    "tpl.air_pm25":          "PM2.5 (µg/m³)",
    "tpl.air_pm10":          "PM10 (µg/m³)",
    "tpl.air_co2":           "CO₂ (ppm)",
    "tpl.air_radon":         "Radon (Bq/m³)",
    "tpl.noise_db":          "Bruit (dB)",
    "tpl.uv_index":          "Indice UV",
    "tpl.alarm":             "Alarme",
    "tpl.cover":             "Volet roulant",
    "tpl.person":            "Présence personne",
    // Card editor
  ...
  en: {
    ...
    "card.mode.edit":      "✏ Edit",
    "card.mode.view":      "👁 View",
    "card.view.hint":      "Click a LED to see the assigned entity",
    "card.live":           "⬤ Live",
    ...
    "tpl.on_off":            "On/Off",
    "tpl.unavailable_alert": "Unavailable alert",
    "tpl.temp_hot":          "Hot temperature (equipment)",
    "tpl.temp_fridge":       "Refrigerator (°C)",
    "tpl.temp_freezer":      "Freezer (°C)",
    "tpl.temp_room":         "Room / comfort (°C)",
    "tpl.humidity_plant":    "Soil / plant humidity (%)",
    "tpl.humidity_room":     "Indoor humidity (%)",
    "tpl.power_instant":     "Power (W)",
    "tpl.energy_period":     "Energy (kWh)",
    "tpl.air_pm25":          "PM2.5 (µg/m³)",
    "tpl.air_pm10":          "PM10 (µg/m³)",
    "tpl.air_co2":           "CO₂ (ppm)",
    "tpl.air_radon":         "Radon (Bq/m³)",
    "tpl.noise_db":          "Noise (dB)",
    "tpl.uv_index":          "UV index",
    "tpl.alarm":             "Alarm",
    "tpl.cover":             "Cover / blind",
    "tpl.person":            "Person presence",
    // Card editor
